  ...
  <IonPage>
    <IonContent>
      <div class="max-w-7xl mx-auto pt-10 bg-white sm:px-6 lg:px-8">
        ...
        <div
          class="min-h-screen flex flex-col gap-5 items-center justify-start"
        >
          <div
            class="w-[370px] h-[200px] shadow-lg z-[1] mx-2 rounded-lg"
            v-if="route.fullPath === '/home'"
          >
            <swiper space-between="30"  class="bg-red flex items-center justify-center">
              <swiper-slide
                class="relative"
              ...
              >
                ...
                >
                  ...
                  <p class="text-sm">
                    ...
                    eget risus porta, interdum justo eu, malesuada nunc.
                  </p>
                </div>
              </swiper-slide>
            </swiper>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <button
              v-if="mainStore.user && mainStore.user.role === 'user'"
            ...
            <button
              v-if="mainStore.user && mainStore.user.role === 'user'"
              @click="router.push({ name: 'user-info2' })"
              class="relative w-36 h-36 bg-green-600 rounded-lg overflow-hidden hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
            >
              <div class="absolute inset-0 flex items-center justify-center">
                <svg
            ...
            <button
              ...
              @click="router.push({ name: 'response' })"
              class="relative w-36 h-36 bg-green-600 rounded-lg overflow-hidden hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
            >
              <div class="absolute inset-0 flex items-center justify-center">
                <svg
            ...
            >
              <div  class="absolute inset-0 flex items-center justify-center">
                <svg    class="w-10 h-10 text-white" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
		<path fill="currentColor" d="M19 4h-3.5l-1-1h-5l-1 1H5v2h14M6 19a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7H6z" />
            ...
            <button
              @click="router.push({ name: 'add-coach' })"
              v-if="mainStore.user && mainStore.user.role === 'admin'"
              class="relative w-36 h-36 bg-green-600 rounded-lg overflow-hidden hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
            >
              <div class="absolute inset-0 flex items-center justify-center">
                <svg
