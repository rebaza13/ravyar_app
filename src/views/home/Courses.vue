  ...
  <div class="max-w-md mx-auto bg-slate-100 rounded-xl overflow-hidden shadow-lg">
    <div class="p-6">
      <div class="relative">
        ...
        <!-- Progress Bar -->
        <div class="flex flex-col h-64 w-12 bg-gray-200 rounded-full overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto pt-6 pb-20 sm:px-6 lg:px-8">
        ...
        <div v-if="mixed" class="flex flex-col gap-5">
          <div v-for="(item, index) in mixed" :key="index">
            ...
            <!-- Courses Section -->
            <section class="bg-gradient-to-t from-emerald-500 to-emerald-300 rounded-3xl shadow-lg mt-4">
